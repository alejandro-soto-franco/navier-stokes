...
from the Biot--Savart kernel and the Leray projection, and to classify
solutions by the curvature of this connection.  The vorticity direction
dyadic $\boldsymbol{\Xi} = \boldsymbol{\xi} \otimes \boldsymbol{\xi}$,
which encodes the geometric content of the Constantin--Fefferman--Majda
direction field nonlocally, lives naturally on the Veronese surface
$V^{2} \subset S^{5}$.  By working with this object rather than the
pointwise vorticity direction $\boldsymbol{\omega}/|\boldsymbol{\omega}|$,
one avoids the regularity difficulties inherent in controlling the direction
field at points where the vorticity vanishes.  The programme then asks
whether incompressibility, combined with the curvature constraints imposed
by the connection, obstructs finite-time blowup.
